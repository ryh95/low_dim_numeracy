...
from num_word_split_view.local_utils import KernelDistance, cosine_distance, prepare_fitting_data, Minimizer
...
# report the best results on that kernel
...
# evaluate embs in the hilbert space
